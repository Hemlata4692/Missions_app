...
- (void)viewWillAppear:(BOOL)animated {
    ...
    if (([[UIDevice currentDevice] userInterfaceIdiom] ==  UIUserInterfaceIdiomPad)) {
        ...
        self.emojiCollectionView.frame = CGRectMake(([[UIScreen mainScreen] bounds].size.width/2) - 200, 170, 400, [[UIScreen mainScreen] bounds].size.height - 261);//here frame = CGRectMake(([[UIScreen mainScreen] bounds].size.width/2) - 200(half of collectionView width), 90(top space), 400(collection view fix in iPad), [[UIScreen mainScreen] bounds].size.height - 261(41(top space of mainController view)+90(top space of collection view)+8(bottom space of collection)+58(bottom space of mainController view)+64(navigation bar height)));
    }
    //end
    ...
    if (([[UIDevice currentDevice] userInterfaceIdiom] !=  UIUserInterfaceIdiomPad)) {
        ...
        self.attachmentView.frame= CGRectMake(0, 98, [[UIScreen mainScreen] bounds].size.width-20, 250);
    }
