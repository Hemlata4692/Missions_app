...
- (void)viewWillAppear:(BOOL)animated {
    ...
    if (([[UIDevice currentDevice] userInterfaceIdiom] ==  UIUserInterfaceIdiomPad)) {
        ...
        self.starCollectionView.frame = CGRectMake(([[UIScreen mainScreen] bounds].size.width/2) - 270, self.starCollectionView.frame.origin.y, 550, 150);
    }
    
    //set question text view frame
    self.questionTextView.translatesAutoresizingMaskIntoConstraints=YES;
    self.questionTextView.frame=CGRectMake(10, 28, [[UIScreen mainScreen] bounds].size.width-40, 38);
