...
- (void) addProgresBar {
    ...
    CGFloat progressCountColor=(float)([[[[[UserDefaultManager getValue:@"progressDict"] objectForKey:[UserDefaultManager getValue:@"missionId"]] componentsSeparatedByString:@","] objectAtIndex:0] intValue]+1.0f)/(float)[[[[[UserDefaultManager getValue:@"progressDict"] objectForKey:[UserDefaultManager getValue:@"missionId"]] componentsSeparatedByString:@","] objectAtIndex:1] intValue]; //No. of question
   ...
   //set attributed text on label
    NSString * countString =[NSString stringWithFormat:@"%d",[[[[[UserDefaultManager getValue:@"progressDict"] objectForKey:[UserDefaultManager getValue:@"missionId"]] componentsSeparatedByString:@","] objectAtIndex:0] intValue]+1];
    NSString * numberOfViewCount=[NSString stringWithFormat:@"%d",[[[[[UserDefaultManager getValue:@"progressDict"] objectForKey:[UserDefaultManager getValue:@"missionId"]] componentsSeparatedByString:@","] objectAtIndex:1] intValue]];
...
- (void)setTextViewAlignment:(UITextView *)textView {
    ...
    if ([textView sizeThatFits:textView.frame.size].height>40) {
        textView.contentOffset=CGPointMake(0, 5);
    }
    else {
        textView.contentOffset=CGPointMake(0, -5);
    }}
